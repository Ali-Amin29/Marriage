                ...
                <div class="col-md-6">
                    ...
                    <form class="row flex-column align-items-center">
                        <div class="form-group col-md-8">
                            ...
                            <input type="text" class="form-control border border-primary text-primary"
                                id="floatingInputEmail" placeholder="ادخل رقم الهاتف" />
                        </div>
                        ...
                        <div class="form-group col-md-8">
                            ...
                            <input type="password" class="form-control border border-primary text-primary"
                                id="floatingInputEmail" placeholder="ادخل كلمة المرور " />
                        </div>
                        <div class="col-sm-4">
                        ...
                        <div class="row flex-column align-items-center">
                            ...
                            <a class="text-center mb-4 small" href="{{ url('/checkregister') }}">هل ليس لديك حساب ؟ سجل من
                                هنا</a>
                        </div>
